...
class PersonalInfo extends React.Component{
    ...
    componentDidUpdate(previousProps){
        if(previousProps.data !== this.props.data){
            ...
            if(this.props.data.date_of_birth === null) dob = null
            else dob                     = new Date(this.props.data.date_of_birth);
    ...
    handleSubmit(){
        ...
        Axios.post(process.env.REACT_APP_DEV_BASEURL + 'v1/users/personal-info',formData,
    ...
    handleChangeData(event){
        ...
        if(key === "national_id") 
            event.target.value.toString().length < 16 ? this.setState({validate_national_id : true}) : 
            this.setState({validate_national_id : false})
                 ...
                 <Form>
                    ...
                    <Col sm={6}>
                        ...
                        <Form.Group controlId="7">
                            ...
                            {
                                this.state.validate_national_id && 
                                <Form.Label style={{color:"red"}}>National ID Not Valid</Form.Label>
                            }
                        </Form.Group>
                        ...
                        <Form.Group controlId="12">
                            ...
                            <Form.Control 
                                ...
                                value={
                                    this.state.newData.spouses ? 
                                        this.state.newData.spouses[0] ? this.state.newData.spouses[0].gender : "Select Gender"
                                    : undefined
                                }
                                className="option">
                    ...
                    <Col sm={6}>
                        ...
                        {
                        this.state.newData.childrens && this.state.newData.childrens[0] &&
                                this.state.newData.childrens[0].proof !== null ? 
                        ...
                        <Form.Group controlId="17">
                            ...
                            {
                                this.state.newData.childrens && this.state.newData.childrens[1] &&
                                this.state.newData.childrens[1].proof !== null ? 
                        ...
                        {
                            this.state.newData.childrens && this.state.newData.childrens[2] &&
                            this.state.newData.childrens[2].proof !== null ? 
