...
import TabEmployeeManager from "./TabEmployeeManager";

class HomeTeamDetail extends React.Component{
    constructor(props){
        super();
        this.state = {
            active:false,
    ...
    componentDidMount(){
        this.setState({id_team : this.props.match.params.id})
        ...
        return(
            <div className="wrapper">
                ...
                <div id="content">
                    ...
                    <TabEmployeeManager id_team={this.state.id_team}/>
                </div>
            </div>
        );
    }
